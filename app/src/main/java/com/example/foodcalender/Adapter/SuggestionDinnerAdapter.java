...
public class SuggestionDinnerAdapter extends RecyclerView.Adapter<SuggestionDinnerAdapter.ViewHolder> {
    ArrayList<Food> foodDomains;
    private Context mContext ;


    public SuggestionDinnerAdapter(Context mContext,ArrayList<Food> FoodDomains) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View inflate = LayoutInflater.from(parent.getContext()).inflate(R.layout.viewholder_suggestion_dinner, parent, false);
...
//        });
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            linearLayout=itemView.findViewById(R.id.suggestionDinner);
