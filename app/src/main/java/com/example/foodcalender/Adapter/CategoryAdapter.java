...
import com.example.foodcalender.Activity.CategoriesActivity;
import com.example.foodcalender.Activity.CategoryActivity;
...
public class CategoryAdapter extends RecyclerView.Adapter<CategoryAdapter.ViewHolder> {
    ...
    public CategoryAdapter(Context mContext,ArrayList<CategoryDomain> categoryDomains) {
